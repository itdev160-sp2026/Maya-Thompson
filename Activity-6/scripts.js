...
// Utility functions
// Gives each task a unique id
function generateTaskId() {
  return todoState.nextId++;
}
// Used to provide current time stamp of when the task was created
function getCurrentTimestamp() {
  return new Date().toLocaleString();
}

// Validates the entered task
...
// Adds information about the added task into the console
...
// Passes the taskId into this function so that the right task is deleted
// also checks if that id is valid
...
// Changes whether the clicked task is completed or pending
...
function filterTasks(filterType) {
  ...
  taskElements.forEach((element) => {
    ...
    const task = todoState.tasks.find((t) => t.id === taskId);
// Filters the tasks displayed based on their filterType which is defined 
// in the function updateDisplay below
    let shouldShow = true;
